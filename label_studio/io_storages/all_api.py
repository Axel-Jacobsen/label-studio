...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        responses={
            "200": "A list of import storages types {'name': name, 'title': title}."
        },
    ),
)
class AllImportStorageTypesAPI(APIView):
    ...
    def get(self, request, **kwargs):
        return Response(
            [{'name': s['name'], 'title': s['title']} for s in _common_storage_list]
        )
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        responses={
            "200": "A list of export storages types {'name': name, 'title': title}."
        },
    ),
)
