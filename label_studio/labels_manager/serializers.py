...
class LabelListSerializer(serializers.ListSerializer):
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            links = LabelLink.objects.filter(
...
class LabelLinkSerializer(FlexFieldsModelSerializer):
    ...
    class Meta:
        ...
        expandable_fields = {
            'label': (
                'labels_manager.serializers.LabelSerializer',
                {'omit': ['links', 'projects']},
            )
        }
...
class LabelSerializer(FlexFieldsModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        expandable_fields = {
            'links': ('labels_manager.serializers.LabelLinkSerializer', {'many': True})
        }


class LabelBulkUpdateSerializer(serializers.Serializer):
    project = serializers.PrimaryKeyRelatedField(
        queryset=Project.objects.all(), required=False, default=None
    )
