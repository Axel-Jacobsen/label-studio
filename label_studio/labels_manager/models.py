...
class Label(models.Model):
    created_at = models.DateTimeField(
        _('Created at'), auto_now_add=True, help_text='Time of label creation'
    )
    updated_at = models.DateTimeField(
        _('Updated at'), auto_now=True, help_text='Time of label modification'
    )
    ...
    description = models.TextField(
        _('Description'), help_text=f'Label description', blank=True, null=True
    )
    ...
    organization = models.ForeignKey(
        'organizations.Organization', related_name='labels', on_delete=models.CASCADE
    )
...
class LabelLink(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=['project', 'label'], name='unique_label_project'
            )
        ]
