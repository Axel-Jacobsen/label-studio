...
class ProjectSerializer(FlexFieldsModelSerializer):
    ...
    task_number = serializers.IntegerField(
        default=None, read_only=True, help_text='Total task number in project'
    )
    ...
    created_by = UserSimpleSerializer(
        default=CreatedByFromContext(), help_text='Project owner'
    )
    ...
    finished_task_number = serializers.IntegerField(
        default=None, read_only=True, help_text='Finished tasks'
    )
    ...
    def to_internal_value(self, data):
        ...
        if 'expert_instruction' in initial_data:
            data['expert_instruction'] = bleach.clean(
                initial_data['expert_instruction'],
                tags=SAFE_HTML_TAGS,
