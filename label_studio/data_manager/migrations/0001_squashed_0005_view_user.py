        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'type',
                    models.CharField(
                        help_text='Field type', max_length=1024, verbose_name='type'
                    ),
                ),
                (
                    'operator',
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text='To keep filter order',
                        verbose_name='index',
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'conjunction',
                    models.CharField(
                        help_text='Type of conjunction',
                        max_length=1024,
                        verbose_name='conjunction',
                    ),
                ),
                (
                    'filters',
