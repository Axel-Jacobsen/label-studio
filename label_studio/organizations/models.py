...
class OrganizationMember(models.Model):
    ...
    def find_by_user(cls, user_or_user_pk, organization_pk):
        ...
        return OrganizationMember.objects.get(
            user=user_pk, organization=organization_pk
        )
...
class Organization(OrganizationMixin, models.Model):
    ...
    def find_by_user(cls, user):
        memberships = OrganizationMember.objects.filter(user=user).prefetch_related(
            'organization'
        )
    ...
    def per_project_invited_users(self):
        ...
        invited_ids = self.projects.values_list(
            'members__user__pk', flat=True
        ).distinct()
